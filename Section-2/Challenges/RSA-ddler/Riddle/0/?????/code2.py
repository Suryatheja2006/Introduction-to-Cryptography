...
'''69,203,410,113,561,398,433,978,337,198,079,999,737 = 263 x 263,130,836,933,693,530,167,218,012,159,999,999
print('{:f}'.format(N/alpha))'''
print("All primes smaller than 100: ");
for n in range(10*119,10**121):
	if (isPrime(n, k)):
		if N%n == 0:
			print(n, "FOUND")
			break
